<%@ Page Title="Nạp tiền" Language="C#" MasterPageFile="~/GiaoDien.Master" AutoEventWireup="true" CodeBehind="nap.aspx.cs" Inherits="XoSoTuChonBenTre.nap" %>
     ...
     <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">Nạp tiền vào tài khoản </h4>
