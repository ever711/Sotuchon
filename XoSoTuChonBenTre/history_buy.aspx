<%@ Page Title="" Language="C#" MasterPageFile="~/GiaoDien.Master" AutoEventWireup="true" CodeBehind="history_buy.aspx.cs" Inherits="XoSoTuChonBenTre.history_buy" %>
						  ...
						  <asp:Panel ID="panel1" runat="server" Width="100%" ScrollBars="Auto">
							 ...
							 <Columns>
								 ...
								 <asp:TemplateField>
									 ...
									 <ItemTemplate>
										<%# (Eval("XacNhan").ToString().ToUpper()=="TRUE")?"Đã xác nhận":"Chưa xác nhận" %>
