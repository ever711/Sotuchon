<%@ Page Title="Xác nhận nạp tiền" Language="C#" MasterPageFile="~/GiaoDien.Master" AutoEventWireup="true" CodeBehind="wallet_in_confirm.aspx.cs" Inherits="XoSoTuChonBenTre.wallet_in_confirm" %>
     ...
     <div class="container-full">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">Xác nhận nạp tiền </h4>
								 ...
								 <asp:TemplateField>
									 ...
									 <ItemTemplate>
										<%# (Eval("XacNhan") != null && Eval("XacNhan").ToString().ToUpper()=="TRUE")?"Đã xác nhận": Eval("XacNhan") != null ? "Đã hủy" : "Chưa xác nhận" %><br />
										  <div class="d-flex">
                                             <asp:Button ID="btnXacNhan" Width="90px" Visible='<%# (Eval("XacNhan") == null) %>' runat="server" CssClass="btn btn-default" CommandName="xacnhan" CommandArgument='<%# Eval("IDNap") %>' Text="Xác nhận" />
                                             <asp:Button ID="btnHuy" Width="90px" Visible='<%# (Eval("XacNhan") == null ) %>' runat="server" CssClass="btn btn-danger" CommandName="huyxacnhan" CommandArgument='<%# Eval("IDNap") %>' Text="Huỷ" />
                                         </div>
									 </ItemTemplate>
								 </asp:TemplateField>
								 <asp:TemplateField>
