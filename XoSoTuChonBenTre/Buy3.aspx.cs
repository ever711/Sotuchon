...
{
    public partial class Buy3 : System.Web.UI.Page
    {
        ...
        protected void DList_4_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "chon")
            {
                GridViewRow row = (GridViewRow)(((Control)e.CommandSource).NamingContainer);
                ...
                {
                    lblChon.BackColor = System.Drawing.Color.Red;
                    foreach (GridViewRow item in DList_4.Rows)
                    {
                        Label lblSTT1 = (Label)item.FindControl("lblSTT");
                        LinkButton lblChon1 = (LinkButton)item.FindControl("lblChon");
                        if (lblSTT1.Text != lblSTT.Text)
        ...
        private bool checkChonSo()
        {
            ...
            foreach (GridViewRow item3 in DList_4.Rows)
            {
                LinkButton lblChon = item3.FindControl("lblChon") as LinkButton;
                Label lblSTT = item3.FindControl("lblSTT") as Label;
                if (lblChon.BackColor.Name == "Red")
        ...
        protected void btn4Lo_Click(object sender, EventArgs e)
        {
            setColor(sender);
            btn16Lo.CssClass = "btn btn-dark";
        }

        protected void btn16Lo_Click(object sender, EventArgs e)
        {
            setColor(sender);
            btn4Lo.CssClass = "btn btn-dark";
        }
        ...
        private void TaoGioHang()
        {
            ...
            if (strNum.Length == 4)
            {
                if (strSoTien != "0")
                {
                    ...
                    if (btn4Lo.CssClass == "btn btn-danger")
                    {
                        row["Lo"] = btn4Lo.ToolTip;
                        dt.Rows.Add(row);
                    }
                    else if (btn16Lo.CssClass == "btn btn-danger")
                    {
                        row["Lo"] = btn16Lo.ToolTip;
                        dt.Rows.Add(row);
                    }
