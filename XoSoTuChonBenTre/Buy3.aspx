<%@ Page ValidateRequest="false" Title="" Language="C#"  MasterPageFile="~/GiaoDien.Master" AutoEventWireup="true" CodeBehind="Buy3.aspx.cs" Inherits="XoSoTuChonBenTre.Buy3" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <style>
                        ...
                        .circleModal .number.active{background-color:#fa3;color:#FFF;border-color:#fa3}
                    </style>
                             ...
                             <div class="col-lg-12">
                                  <div class="form-group">
                                      <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                             <ContentTemplate>
                                                  <asp:Button ID="btn4Lo"  ToolTip="4L" runat="server" Text="4 Lô" CssClass="btn btn-dark" OnClick="btn4Lo_Click" />
                                                   <asp:Button ID="btn16Lo"  ToolTip="BL" runat="server" Text="Lô" CssClass="btn btn-dark" OnClick="btn16Lo_Click" />
                                     </ContentTemplate>
                                           <Triggers>
                                        ...
                                        <div class="box-number box-number0 flex-d cursor-pointer">
                                             ...
                                             <div style="float:left">
                                                 <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                    <ContentTemplate>
                                                   <asp:GridView ID="DList_4"   ShowHeader="false" CssClass="table-responsive" OnRowCommand="DList_4_RowCommand"  AutoGenerateColumns="false" border="0" Width="100%" runat="server">
                                                      <Columns>
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                       <asp:Label ID="lblSTT" runat="server" Text='<%# Eval("stt")%>' Visible="false"></asp:Label>
                                              ...
                                              <div style="float:left; padding-left:50px; ">
                                                 <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                  ...
                                                  <div style="padding-bottom:5px;padding-top:120px;">
                                                      <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                                            <ContentTemplate>
                                                                  <asp:Button ID="btnChon" runat="server" Text="Chọn" width="100px"  CssClass="btn btn-default" OnClick="btnChon_Click" /><br /><br />
